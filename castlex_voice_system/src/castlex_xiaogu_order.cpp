...
{
	printf(path1.data());
	ros::init(argc, argv, "castlex_xiaogu_order_node");    //初始化节点，向节点管理器注册
	ros::NodeHandle n;
	...
	ros::Publisher pub = n.advertise<std_msgs::String>("/voice/castlex_tl_nlu_topic", 3);
	ros::Publisher cmd_pub = n.advertise<std_msgs::Int32>("/voice/castlex_xiaogu_cmd_topic", 1);
