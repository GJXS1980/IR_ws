...
{   //  初始化ROS节点
    ...
    Robot_Interface.Jog0_Robot_Moment = 3;  // 关节0默认最大力矩
    Robot_Interface.Jog4_Robot_Moment = 25; //关节三默认最大力矩
    Robot_Interface.Start_Moment_Thread = start_moment; //默认开启关节力矩监听线程
